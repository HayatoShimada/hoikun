    ...
    public partial class InitSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PickupTimeSettingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PickupTimeSettings", x => x.PickupTimeSettingId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_Classes_ClassId",
                        column: x => x.ClassId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PickupExpectedTime = table.Column<TimeOnly>(type: "time", nullable: true),
                    ...
                    PickupTimeSettingId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Childrens_PickupTimeSettings_PickupTimeSettingId",
                        column: x => x.PickupTimeSettingId,
                        principalTable: "PickupTimeSettings",
                        principalColumn: "PickupTimeSettingId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: true),
                    CommuteCategory = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FormSubmissionFields_FormFields_FieldId",
                        column: x => x.FieldId,
                        principalTable: "FormFields",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FormSubmissionFields_FormSubmissions_SubmissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Childrens_PickupTimeSettingId",
                table: "Childrens",
                column: "PickupTimeSettingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FormSubmissionFields_FieldId",
                table: "FormSubmissionFields",
                column: "FieldId");

            migrationBuilder.CreateIndex(
                name: "IX_FormSubmissionFields_SubmissionId",
                table: "FormSubmissionFields",
                column: "SubmissionId");
